                ...
                <div className="w-full max-w-sm px-6 py-12 lg:px-8">
                    ...
                    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                            ...
                            <div>
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        className={`block w-full rounded-md px-3 py-1.5 text-base ${darkMode
                        ...
                        <button
                            ...
                            className={`mt-4 flex w-full items-center justify-center rounded-md px-3 py-1.5 text-sm font-semibold shadow-sm ${darkMode
